...
describe("Block", () => {
    ...
    describe("mineBlock()", () => {
        ...
        it("sets the `lastHast` variable to be the `hash` of the last block", () => {
        ...
        it("generates a SHA-256 `hash` based on the proper inputs", () => {
        ...
        it("sets a `hash` meeting difficulty criteria", () => {
            expect(
